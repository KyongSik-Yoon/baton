<!-- Source: sr_opus_5_system_prompt.md from the "Fixing Opus 5" repo by IndyDevDan, MIT license. -->
<!-- Adapted for baton (styles/claude-opus-5.md): minor typo fixes only, no wording changes. -->
